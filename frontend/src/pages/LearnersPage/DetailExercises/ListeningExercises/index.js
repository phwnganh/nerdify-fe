...
const imagesArr = {
  demo1_1, demo1_2, demo1_3,
  demo2_1, demo2_2, demo2_3,
  demo3_1, demo3_2, demo3_3,
};

const audioArr = {
  part1_ques1, part1_ques2, part1_ques3,
  part2_ques7, part2_ques8, part2_ques9,
  part3_ques11, part3_ques12, part3_ques13,
};
        ...
        <TabPane tab="Questions and Answers" key="questionsAnswers">
          ...
          <div style={{ textAlign: "center", paddingTop: "50px" }}>
            <ButtonCustom
              ...
              style={{ padding: "23px" }}
              onClick={() => setCurrentPartIndex((prev) => Math.max(prev - 1, 0))}
