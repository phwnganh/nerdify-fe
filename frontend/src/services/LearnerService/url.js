...
const URI_FLASHCARDS_SERVICE = {
  ...
  REMOVE_FOLDER: API_PREFIXES.FLASHCARD + "/folders",
  REMOVE_FLASHCARD_IN_FOLDER: API_PREFIXES.FLASHCARD + "/remove-flashcard-folders",
  VIEW_FLASHCARD_HISTORY: API_PREFIXES.FLASHCARD + "/history",
